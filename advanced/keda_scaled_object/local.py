...
KEDA_GROUP = "keda.sh"
CONFIG_FILE = "/home/bjs-lap-57/.kube/clusters/bjs-eks-cluster.config"
...
def create_configmap(deployment_name, namespace, scaled_object, replicas):
    ...
    # Remove the resourceVersion field
    if "resourceVersion" in body.metadata.to_dict():
        del body.metadata.to_dict()["resourceVersion"]
